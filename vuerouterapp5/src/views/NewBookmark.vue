...
<div class="form-area card border p-2">
  ...
  <input type="text" v-model="userData.title" class="form-control" id="title" placeholder="kablosuz kedi ">
</div>
<div class="mb-3">
  ...
  <textarea class="form-control" v-model="userData.description" placeholder="burası...." id="description" rows= "3"></textarea>
...
export default {
  ...
  //butona basıldığı zaman kayıt yapılacak//
  methods: {
    onSave() {
